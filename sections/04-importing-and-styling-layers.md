...
![Screenshot of a layer on an ArcGIS online map, with panes of information on either side of the map]({{ site.baseurl }}/images/AO-new-layer-added.png)
...
![Screenshot of the ArcGIS Online layer options]({{ site.baseurl }}/images/AO-new-layer-options.png)
...
![Screenshot of an ArcGIS Online map with Symbol Style and Style options panes open on the right.]({{ site.baseurl }}/images/AO-new-layer-styling.png)
...
![Screenshot of an ArcGIS Online layer with two attributes mapped]({{ site.baseurl }}/images/AO-new-two-attributes.png)
